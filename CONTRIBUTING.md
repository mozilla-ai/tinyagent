...
- [ ] Search [existing issues](https://github.com/mozilla-ai/tinyagent/issues) for duplicates
- [ ] Check [open pull requests](https://github.com/mozilla-ai/tinyagent/pulls) to see if someone is already working on it
...
This serves the docs at `http://127.0.0.1:8000`.
...
Avoid the placeholder commit message above; replace it with the real one.

### 2. Create a Pull Request

1. Go to https://github.com/mozilla-ai/tinyagent
...
- 💬 Open a [GitHub Discussion](https://github.com/mozilla-ai/tinyagent/discussions)
- 🐛 Report a [Bug](https://github.com/mozilla-ai/tinyagent/issues/new?template=bug_report.md)
- 💡 Request a [Feature](https://github.com/mozilla-ai/tinyagent/issues/new?template=feature_request.md)
