...
pytest.importorskip("tinyagent.tools.a2a")
...
from tinyagent.tools.a2a import a2a_tool, a2a_tool_async
...
async def mock_a2a_tool(
    ...
    with (
        patch("tinyagent.tools.a2a.A2ACardResolver") as mock_resolver,
        patch("tinyagent.tools.a2a.A2AClient") as mock_client_class,
    ):
        # Setup resolver mock
...
def test_async_tool_name_default() -> None:
    ...
    fun_name = "some_name"
    with patch("tinyagent.tools.a2a.A2ACardResolver.get_agent_card") as agent_card_mock:
