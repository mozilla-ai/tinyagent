...
class GenAI:
    ...
    We only expose the keys that we currently use in `tinyagent`.
    """
...
class TinyAgentAttributes:
    """Span-attribute keys specific to TinyAgent library."""

    VERSION = "tinyagent.version"
    """The tinyagent library version used in the runtime."""
