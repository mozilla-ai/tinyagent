"""Simplified MCP client that handles all transport types."""
...
class MCPClient(BaseModel):
    """Unified MCP client that handles all transport types."""
    ...
    def model_post_init(self, __context: Any, /) -> None:
        ...
        if missing_mcp_error:
            msg = "MCP support requires the `mcp` package; reinstall mozilla-ai-tinyagent."
