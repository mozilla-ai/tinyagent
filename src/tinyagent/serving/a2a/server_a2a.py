...
from tinyagent.serving.server_handle import ServerHandle

from .agent_card import _get_agent_card
from .agent_executor import TinyAgentExecutor
...
async def _get_a2a_app_async(
    agent: TinyAgent, serving_config: A2AServingConfig
    ...
    request_handler = DefaultRequestHandler(
        agent_executor=TinyAgentExecutor(
