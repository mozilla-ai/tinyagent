...
from tinyagent import AgentRunError
...
from tinyagent.serving.a2a.context_manager import ContextManager
...
class TinyAgentExecutor(AgentExecutor):
    """TinyAgentExecutor Implementation with task management for multi-turn conversations."""
    ...
    def __init__(
        ...
        """Initialize the TinyAgentExecutor.
